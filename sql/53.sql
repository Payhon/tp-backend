...
BEGIN
  ...
  SELECT
    'b9d0a501-6d9d-4de0-a2eb-8f4fd15f1024', battery_list_id,
    'bms_battery_list_action_lifecycle_factory_restore', 4, 13035,
  ...
  WHERE NOT EXISTS (
    SELECT 1 FROM public.sys_ui_elements WHERE element_code = 'bms_battery_list_action_lifecycle_factory_restore'
  );
