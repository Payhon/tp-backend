...
type OtaUpgradePackage struct {
	...
	DeviceKind     int16      `gorm:"column:device_kind;not null;default:1;comment:设备类型 1-BMS 2-仪表 3-4G模块" json:"device_kind"`
	IsLatest       bool       `gorm:"column:is_latest;not null;default:false;comment:是否最新固件" json:"is_latest"` // 是否最新固件
}
