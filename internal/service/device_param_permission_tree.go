			...
			Children: []model.DeviceParamTreeNode{
				...
				},
				{
					...
					Children: []model.DeviceParamTreeNode{
						...
						leafNode("禁止充电", "factory:disableCharge", "0x057A~0x057B(0x80000000)", "disableCharge"),
						leafNode("禁止放电", "factory:disableDischarge", "0x057A~0x057B(0x40000000)", "disableDischarge"),
						leafNode("允许充放电", "factory:allowChargeDischarge", "0x057A~0x057B(0x00000000)", "allowChargeDischarge"),
