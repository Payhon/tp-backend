	...
	return []model.DeviceParamTreeNode{
		{
			...
			Children: []model.DeviceParamTreeNode{
				...
				leafNode("回馈过充保护延时", "403:feedback_delay", "0x0403(L)", "FEEDBACK_OC_PROTECT_DELAY_S"),
				...
				leafNode("单体过放告警解除电压", "40e:alarm_release_v", "0x040E", "CELL_UV_ALARM_RELEASE_V"),
				leafNode("单体过放保护解除电压", "40f:protect_release_v", "0x040F", "CELL_UV_PROTECT_RELEASE_V"),
		...
		},
		{
			...
			Children: []model.DeviceParamTreeNode{
				...
				leafNode("放电高温保护解除温度", "44b:protect_release", "0x044B(H)", "DISCHARGE_OT_PROTECT_RELEASE_C"),
